...
public class PhotoPopupWindow extends PopupWindow {//悬浮框
    ...
    private void Init() {
        ...
        Button btn_camera = (Button) mView.findViewById(R.id.icon_btn_camera);//拍照控件
        Button btn_select = (Button) mView.findViewById(R.id.icon_btn_select);//相册控件
        Button btn_cancel = (Button) mView.findViewById(R.id.icon_btn_cancel);//取消控件
